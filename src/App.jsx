  ...
  return (
    <>
        ...
        <div className="container">
          ...
          <section className="content-section" aria-labelledby="about-title">
            <div className="container">
              ...
              <p>
                <strong>Предмет:</strong> Технічна підтримка програмного забезпечення (ТППЗ)<br />
                <strong>Завдання:</strong> Розробка односторінкового веб-сайту для представлення бакалаврської роботи з використанням сучасних веб-технологій та методології Git Flow.
              </p>
              <p>
              ...
              <p>
                <strong>Ключові слова:</strong> Telegram, чат-бот, тестування знань, інформаційна система, React, Vite, Git Flow, лендінг, SEO, доступність, адаптивність, веб-розробка, бакалаврська робота, курсова робота, ТППЗ
              </p>
            </div>
          </section>
      ...
      <footer className="site-footer">
        <div className="container">
          <p>
            2026 Шевченко Кирил Олексійович • СумДУ • Факультет ЕлІТ • Курсова робота (КРБ)
          </p>
        </div>
      </footer>
